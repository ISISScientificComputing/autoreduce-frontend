...
from autoreduce_frontend.selenium_tests.tests.base_tests import (BaseIntegrationTestCase, FooterTestMixin,
                                                                 NavbarTestMixin, AccessibilityTestMixin)


class TestConfigureNewRunsPage(BaseIntegrationTestCase, NavbarTestMixin, FooterTestMixin, AccessibilityTestMixin):
...
class TestConfigureNewRunsPageSkippedOnly(BaseIntegrationTestCase, NavbarTestMixin, FooterTestMixin):
