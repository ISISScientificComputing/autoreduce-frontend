...
class TourMixin:
    ...
    def is_tour_visible(self):
        ...
        """
        return WebDriverWait(self.driver, 10).until(EC.presence_of_element_located((By.ID, self.TOUR_STEP_ID % self.step)))
    ...
    def is_tour_hidden(self):
        ...
        :return: (bool) True if tour is visible, False otherwise
        """
        return WebDriverWait(self.driver, 30).until_not(EC.presence_of_element_located((By.ID, self.TOUR_STEP_ID % self.step)))
