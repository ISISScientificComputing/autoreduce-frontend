...
setup(
    name=PACKAGE_NAME,
    version="22.0.0.dev3",  # when updating the version here make sure to also update webapp.D
    ...
    install_requires=[
        "autoreduce_utils==22.0.0.dev4", "autoreduce_db==22.0.0.dev5", "autoreduce_qp==22.0.0.dev3", "Django==3.2.4",
